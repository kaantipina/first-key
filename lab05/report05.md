...
![Выполним примеры, описанные в лабораторной работе](image5/im01.png){ #fig:001 }
...
![Выполним примеры, описанные в лабораторной работе](image5/im02.png){ #fig:002 }
...
![Выполним примеры, описанные в лабораторной работе](image5/im03.png){ #fig:003 }

![Выполним примеры, описанные в лабораторной работе](image5/im04.png){ #fig:004 }

2. Выполняем следующие действия, отображенные на (рис. -@fig:005a) (рис. -@fig:005b) (рис. -@fig:006) (рис. -@fig:007):
...
![Выполним действия из пункта 2 задания](image5/im05a.png){ #fig:005a }

![Выполним действия из пункта 2 задания](image5/im05b.png){ #fig:005b }

![Выполним действия из пункта 2 задания](image5/im06.png){ #fig:006 }

![Выполним действия из пункта 2 задания](image5/im07.png){ #fig:007 }
...
![Определяем опции команды chmod](image5/im08.png){ #fig:008 }
...
![Просмотрим содержимое файла /etc/passwd](image5/im09.png){ #fig:009 }

![Выполним действия из пункта 4 задания](image5/im10.png){ #fig:010 }

![Выполним действия из пункта 4 задания](image5/im11.png){ #fig:011 }
...
![Команда mount](image5/im12.png){ #fig:012 }
...
![Команда fsck](image5/im13.png){ #fig:013 }
...
![Команда mkfs](image5/im14.png){ #fig:014 }
...
![Команда kill](image5/im15.png){ #fig:015 }
