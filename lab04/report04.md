...
![Полное  имя  домашнего  каталога](image4/im01.png){ #fig:001 }
...
![Переход в каталог /tmp](image4/im001.png){ #fig:0001 }

![Вывод на экран содержимое каталога /tmp с различными опциями](image4/im02.png){ #fig:002 }

![Вывод на экран содержимое каталога /tmp с различными опциями](image4/im03.png){ #fig:003 }

![Вывод на экран содержимое каталога /tmp с различными опциями](image4/im04.png){ #fig:004 }
...
![Есть ли в каталоге /var/spool подкаталог с именем cron](image4/im05.png){ #fig:005 }
...
![Вывод на экран содержимого домашнего каталога](image4/im06.png){ #fig:006 }
...
![Создаем новый каталог newdir](image4/im07.png){ #fig:007 }
...
![Cоздаем каталог morefun](image4/im08.png){ #fig:008 }
...
![Cоздаем каталоги letters, memos и misk](image4/im09.png){ #fig:009 }
...
![Пробуем удалить каталог newdir](image4/im10.png){ #fig:010 }
...
![Удаляем каталог newdir/morefun](image4/im11.png){ #fig:011 }
...
![Определяем опцию -R команды ls](image4/im12.png){ #fig:012 }
...
![Определяем опцию -a команды ls](image4/im13.png){ #fig:013 }

![Определяем опцию -l команды ls](image4/im14.png){ #fig:014 }

![Определяем опцию -t команды ls](image4/im15.png){ #fig:015 }
...
![Команда pwd](image4/im16.png){ #fig:016 }
...
![Команда mkdir](image4/im17.png){ #fig:017 }
...
![Команда rmdir](image4/im18.png){ #fig:018}
...
![Команда rm](image4/im19.png){ #fig:019}
...
![Вывод истории команд](image4/im20.png){ #fig:020}

![Используем с заменой команды из истории](image4/im21.png){ #fig:021}
