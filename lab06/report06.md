...
![Записываем названия файлов, содержащихся в каталоге /etc](image6/im01.png){ #fig:001 }

![Записываем названия файлов, содержащихся в домашнем каталоге](image6/im02.png){ #fig:002 }

![Просматриваем файл](image6/im03.png){ #fig:003 }
...
![Вывожу имена файлов, имеющих расширение .conf](image6/im04.png){ #fig:004 }
...
![Определем, какие файлы начинаются с символа c](image6/im05.png){ #fig:005 }
...
![Вывод на экран (постранично) файлы, начинающиеся с символа h](image6/im06.png){ #fig:006 }
...
![Запускаем в фоновом режиме процесс, который запишет файлы, начинающиеся с log](image6/im07.png){ #fig:007 }

![Проверяем выполненные действия](image6/im08.png){ #fig:008 }

8. Запускаю редактор gedit в фоновом режиме командой «gedit &» (рис. -@fig:009). После этого на экране появляется окно редактора.

![Запускаю редактор gedit в фоновом режиме](image6/im09.png){ #fig:009 }
...
![Определяем идентификатор процесса gedit](image6/im10.png){ #fig:010 }
...
![Используем kill для завершения процесса gedit](image6/im11.png){ #fig:011 }

![Информация о команде kill](image6/im12.png){ #fig:012 }
...
![Информация о команде df](image6/im13.png){ #fig:013 }

![Информация о команде du](image6/im14.png){ #fig:014 }

![Используем df и du](image6/im15.png){ #fig:015 }
...
![Информация о команде find](image6/im16.png){ #fig:016 }

![Вывод имен всех директорий, имеющихся в домашнем каталоге](image6/im17.png){ #fig:017 }
